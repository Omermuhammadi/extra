...
import { Sparkles, Layers, Droplets, HardHat, Trash2, Wrench, Users, ArrowRightLeft, Maximize } from "lucide-react";
...
const services: Service[] = [
  ...
  { id: "005", title: "Dumpster Rentals", description: "Fast delivery of small, medium, and large dumpsters for contractor renovations and heavy debris removal.", icon: Trash2, image: "/5.png" },
